...
```go
import "github.com/0chain/egosdk/wasmsdk"
```
...
<a name="InvalidArg"></a>
## func [InvalidArg](<https://github.com/0chain/egosdk/blob/doc/initial/wasmsdk/errors.go#L9>)
...
## func [RequiredArg](<https://github.com/0chain/egosdk/blob/doc/initial/wasmsdk/errors.go#L5>)
...
## type [CheckStatusResult](<https://github.com/0chain/egosdk/blob/doc/initial/wasmsdk/response.go#L18-L22>)
...
## type [DownloadCommandResponse](<https://github.com/0chain/egosdk/blob/doc/initial/wasmsdk/response.go#L10-L16>)
...
## type [FileCommandResponse](<https://github.com/0chain/egosdk/blob/doc/initial/wasmsdk/response.go#L5-L8>)
